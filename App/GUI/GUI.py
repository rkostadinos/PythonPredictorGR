...
def calculate_points(player1_score, player2_score, match_result):
    ...
    elif (player1_predicted_home > player1_predicted_away and actual_home_score > actual_away_score) or (player1_predicted_home < player1_predicted_away and actual_home_score < actual_away_score):
        player1_points = 2  # Ο Παίκτης 1 βρήκε τη νικήτρια ομάδα
    ...
    elif (player2_predicted_home > player2_predicted_away and actual_home_score > actual_away_score) or (player2_predicted_home < player2_predicted_away and actual_home_score < actual_away_score):
        player2_points = 2  # Ο Παίκτης 2 βρήκε τη νικήτρια ομάδα
